# helm-charts/serviceexample/templates/_helpers.tpl
{{/*
...
helm.sh/chart: {{ include "serviceexample.chart" . }}
{{ include "serviceexample.selectorLabels" . }}
{{- if .Chart.AppVersion }}
